...
package com.twq.spark.atlas.sql.testhelper

import java.util

import com.twq.spark.atlas.types.metadata

import scala.collection.JavaConverters._
import com.twq.spark.atlas.utils.{AtlasUtils, TestUtils}
import com.twq.spark.atlas.{SACAtlasEntityWithDependencies, SACAtlasReferenceable}
import com.twq.spark.atlas.AtlasEntityReadHelper.getOnlyOneEntity
